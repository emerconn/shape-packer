...
This is a fork of [Flamethrower's shape-packer](https://github.com/Flamethr0wer/shape-packer). All credit goes to him for the crazy math he did.
...
./shape-packer  8.55s user 1.90s system 950% cpu 1.099 total
```
