...
My fork is an optimized version, roughly 40x faster than the original Python version. Both tests are ran on the same PC (AMD Ryzen 9 5950X) under the same conditions.
